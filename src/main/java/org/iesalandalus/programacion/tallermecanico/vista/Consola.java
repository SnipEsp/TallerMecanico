...
public class Consola {
    ...
    public static Revision leerRevision() {
        ...
        // Nota: El controlador deberá buscar el cliente real antes de crear la revisión
        return new Revision(clienteBusqueda, vehiculo, fechaInicio);
    }

    /**
     * Lee el número de horas a añadir a una revisión.
     * 
    ...
    /**
     * Lee el precio del material a añadir a una revisión.
     * 
    ...
    /**
     * Lee la fecha de cierre para una revisión.
